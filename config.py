...
GEMINI_CHAT_MODEL: str = "gemini-3.5-flash"           # Chat, routing y code — reemplaza gemini-2.5-flash (deprecado 17 jun 2026)
GEMINI_IMAGE_MODEL: str = "gemini-3.1-flash-image"    # Generación de imágenes — Nano Banana 2 (GA mayo 2026)
GEMINI_CODE_MODEL: str = "gemini-3.5-flash"            # Code execution — tier gratuito
